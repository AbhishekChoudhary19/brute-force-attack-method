@echo off
	...
	cd BF_Files
	title The WI-FI Brute Forcer - Developed By ABHISHEK CHOUDHARY
	set /a attempt=1
	del attempt.xml
	del infogate.xml
	cls
    ...
    echo.
    echo.                       Developed By ABHISHEK CHOUDHARY
    echo.
    echo  [---------------------------------------------------------------------------]
    echo.
    pause
	...
	if !mainmenuchoice!==help (
		...
		echo.
		echo.
		echo  Other projects of Abhishek Choudhary:
		echo  "https://github.com/AbhishekChoudhary19"
		echo.
		echo  This project's UI has maden possible with Glidenet group.
		echo  "https://github.com/AbhishekChoudhary19"
		echo.
		echo  Press any key to continue...
		pause >nul
